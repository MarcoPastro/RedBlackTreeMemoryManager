...
CustomAllocatorRBTree::CustomAllocatorRBTree(size_t totalSize) {
...
CustomAllocatorRBTree::~CustomAllocatorRBTree() {
...
void* CustomAllocatorRBTree::Allocate(size_t size) {
...
void CustomAllocatorRBTree::Deallocate(void* ptr, size_t size) {
...
void CustomAllocatorRBTree::DeleteNodeOnList(char* address) {
...
void CustomAllocatorRBTree::ModifyNodeOnList(char* oldAddress, char* address, size_t newSize) {
    FreeBlock* curr = firstNode;
    if (curr == nullptr) return;
...
void CustomAllocatorRBTree::AddNodeOnList(char* address, size_t size) {
    FreeBlock* curr = firstNode;
    if (curr == nullptr) {
...
void CustomAllocatorRBTree::MergeNodeOnList(FreeBlock* nodeOnList, char* address, size_t size) {
...
void CustomAllocatorRBTree::MergeNodeOnList(FreeBlock* nodeOnList, char* address, size_t size, FreeBlock* nodeNextOnList) {
    freeRBtree->Remove(nodeOnList->address, nodeOnList->size);
